...
if __name__ == "__main__":
    teacher_model = BertForSequenceClassification.from_pretrained(checkpoint,num_labels=label_num,output_hidden_states=True)
    if from_pretrained:
        student_model= BertForSequenceClassification.from_pretrained(ck_stu,num_labels=label_num,output_hidden_states=True)
    else:
    ...
    if glue_task !="mnli":
        ...
        doMetatrain(teacher_model=teacher_model,student_model=student_model,train_dataloader=train_dataloader,val_dataloader=None,val_dataloader_m=val_dataloader_m,val_dataloader_mm=val_dataloader_mm)
